...
export default function CTASection() {
  return (
    <section className="py-32 md:py-48 relative overflow-hidden bg-[#09090B] flex items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto px-6 py-3 text-center relative z-10">
        <ScrollReveal direction="scale">
          <div className="flex justify-center  mb-16 md:mb-24">
            <GlowButton
              ...
              className="text-xl font-bold shadow-[0_0_50px_-10px_rgba(79,70,229,0.5)]"
            />
          </div>

          <div className="flex flex-col md:flex-row flex-wrap justify-center items-center text-md gap-4 md:gap-12  font-bold uppercase tracking-[0.2em] text-zinc-500">

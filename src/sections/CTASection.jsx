...
const ScrollReveal = ({ children, delay = 0, direction = 'scale', className }) => {
        ...
        <section className="py-32 md:py-48 relative overflow-hidden bg-[#09090B] flex items-center justify-center">
            ...
            <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
                <ScrollReveal direction="scale">
                    ...
                    <h2 className="text-4xl md:text-6xl lg:text-6xl font-black text-white mb-12 tracking-tighter leading-[0.9] drop-shadow-2xl  select-none">
                        The future of <br className="hidden md:block" />
                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/50">outbound</span> <br />
                        is an <span className="text-indigo-500 inline-block relative">
                            Autopilot
                    ...
                    <div className="flex justify-center mb-16 md:mb-24">
                        <GlowButton 
                            text="DEPLOY YOUR FREE AUTOPILOT" 
                            onClick={() => window.open('https://app.nexuscale.ai/users/register', '_blank')}
                            className="shadow-[0_0_50px_-10px_rgba(79,70,229,0.5)]"
                        />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap justify-center items-center gap-4 md:gap-12 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                        <span className="flex items-center gap-3 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors cursor-default">
                            ...
                            <span className="text-zinc-400">30-Day Money-Back Guarantee</span>
                        </span>
                        ...
                        <span className="flex items-center gap-3 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors cursor-default">
                            ...
                            <span className="text-zinc-400">Get 100 Leads Free</span>
                        </span>
                        ...
                        <span className="flex items-center gap-3 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors cursor-default">
                            ...
                            <span className="text-zinc-400">3-Min Setup</span>
                        </span>
                    </div>
                </ScrollReveal>
            </div>

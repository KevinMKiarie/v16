...
export default function ReviewsSection() {
  ...
  return (
    <section
      className={`mx-6 mb-32 rounded-[4rem] bg-[#050505] border border-white/5 relative overflow-hidden shadow-2xl`}
    >
      ...
      <div className="relative z-10 w-full h-[800px] overflow-hidden py-32">
        <ScrollReveal>
          <div className="text-center mb-24 max-w-7xl mx-auto px-6">
            <h2 className="text-4xl md:text-6xl lg:text-6xl font-bold text-white tracking-tighter justify-center mb-8 leading-[0.9] max-w-4xl mx-auto">

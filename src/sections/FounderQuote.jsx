    ...
    <section className="py-40 max-w-4xl mx-auto px-6 text-center relative">
      <ScrollReveal direction="scale">
        <div className="mb-16 relative z-10">
          <p className="text-3xl md:text-5xl font-serif italic text-white leading-relaxed opacity-90 drop-shadow-lg">
            "We didn't build an AI to automate tasks. We built it to automate
            thought. It's the strategic brain I wish I'd had on day one."
          </p>
        </div>

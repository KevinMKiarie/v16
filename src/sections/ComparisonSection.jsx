...
function StackVisual() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-full min-h-[180px] flex items-center justify-center overflow-hidden"
    >
      ...
      <div
        ref={nexusRef}
        className="absolute right-4 sm:right-10 top-1/2 -translate-y-1/2 z-20 w-14 h-14 rounded-2xl bg-zinc-900 border-2 border-indigo-400/50 flex flex-col items-center justify-center shadow-[0_0_40px_rgba(99,102,241,0.4)]"
      >
        <img
        ...
        />
        <span className="text-[7px] font-black text-white/90 uppercase tracking-widest mt-0.5">
          NEXUS
        </span>
      </div>
...
function OldStackCarousel() {
  ...
  useEffect(() => {
    const timer = setInterval(
      () => setActive((p) => (p + 1) % oldStack.length),
      4000,
    );
        ...
        return (
          ...
          >
            <div
              ...
              style={{
                boxShadow: isActive ? `0 4px 28px ${tool.glow}` : "none",
              }}
            >
              ...
              <span className="text-sm font-bold text-zinc-400 z-10">
                {tool.price}
              </span>
            </div>
          </motion.div>
        ...
        <div className="flex flex-col gap-3 mb-10 md:mb-14 items-center text-center">
          ...
          <ScrollReveal>
            ...
            <p className="mt-3 text-sm sm:text-base text-zinc-400 max-w-xl mx-auto font-medium leading-relaxed">
              ...
              You're the one making them talk and paying three invoices to do
              it.
            </p>
          </ScrollReveal>
        </div>

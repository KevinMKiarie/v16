...
export default function ComparisonStack() {
  return (
    <section
      className={`py-12 w-full md:px-6  rounded-[3rem] border  mx-auto border-white/10 relative overflow-hidden ${neu.inset}`}
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal direction="right" delay={400}>
            <SpotlightCard
              ...
              className="relative p-2 md:p-10 rounded-3xl w-full h-full bg-[#09090B] border border-indigo-500/50 flex flex-col items-center justify-center text-center shadow-[0_0_60px_-10px_rgba(120,127,246,0.4)]"
            >

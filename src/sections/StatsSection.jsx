...
export default function StatsSection() {
  ...
  return (
    <div
      className={`py-32 bg-[#050505] border-y border-white/[0.03] shadow-inner`}
    >
      <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-16 text-center relative z-10">
        <div ref={ref1}>
          <div
            className={`text-7xl font-bold ${neu.textVibrant} tracking-tighter mb-4 drop-shadow-2xl`}
          >
            {count1}
          </div>
          <div className="text-zinc-500 font-bold uppercase text-xs tracking-[0.2em] mb-2">
            Meetings Booked
          </div>

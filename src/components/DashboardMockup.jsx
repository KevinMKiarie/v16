...
export default function DashboardMockup() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-6xl mx-auto mt-24 perspective-[2000px] group"
    >
      ...
      {/* Main Window */}
      <div
        className={`relative rounded-3xl ${neu.glass} shadow-2xl overflow-hidden transform transition-transform duration-700 hover:scale-[1.005] ring-1 ring-white/10`}
      >
        {/* Window Controls */}
        ...
        <div className="flex flex-col md:flex-row h-[650px]">
          ...
          <div className="w-full md:w-80 border-r border-white/[0.06] bg-black/20 backdrop-blur-md flex flex-col">
            <div className="p-6 border-b border-white/[0.06]">
              <div className="flex items-center gap-3 text-zinc-400 font-bold text-xs uppercase tracking-wider">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_10px_rgba(16,185,129,0.6)]"></span>
                Live Feed
              </div>
            </div>
              ...
              <div className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.08] relative group/card cursor-pointer hover:bg-white/[0.05] transition-all hover:border-indigo-500/30 hover:shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
                ...
                <div className="pl-4">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-600 flex items-center justify-center text-[10px] font-bold text-white shadow-md">
                      S
                    </div>
          ...
          <div className="flex-1 bg-black/10 relative flex flex-col">
            ...
            <div className="min-h-16 h-auto py-3 border-b border-white/[0.06] flex items-center justify-between px-8 bg-black/20">
              <div
                className={`flex items-center gap-1 bg-black/40 p-1.5 rounded-xl border border-white/[0.05] shadow-inner`}
              >
                <button
              ...
              <div
                className={`flex items-center gap-3 transition-opacity duration-500 ${startTyping ? "opacity-100" : "opacity-0"}`}
              >
            ...
            <div className="p-4 flex-1 overflow-hidden flex flex-col">
              <div
                className={`flex-1 rounded-2xl border border-white/[0.04] bg-[#050505] relative overflow-hidden shadow-inner flex flex-col transition-all duration-500 ${neu.inset}`}
              >
                  ...
                  {activeTab === "email" ? (
                    <>
                      <div className="grid grid-cols-[60px_1fr] gap-6 mb-10 text-sm border-b border-white/[0.04] pb-8 items-center">
                        <span className="text-zinc-500 font-bold uppercase text-xs tracking-wider">
                          To
                        </span>
                        <div className="flex items-center gap-2">
                          <span className="bg-indigo-500/10 text-indigo-200 px-3 py-1 rounded-lg text-xs border border-indigo-500/20 shadow-[0_0_10px_rgba(99,102,241,0.1)] font-medium">
                            sarah@techflow.io
                          </span>
                        </div>
                        <span className="text-zinc-500 font-bold uppercase text-xs tracking-wider">
                      ...
                      <div
                        className={`relative pl-6 border-l-2 transition-all duration-500 ${startTyping ? "border-indigo-500 shadow-[inset_14px_0_20px_-10px_rgba(99,102,241,0.2)]" : "border-transparent"}`}
                      >
                        ...
                        <div className="mb-3 flex flex-wrap gap-x-1 gap-y-2 items-center text-zinc-300">
                          ...
                          />
                          <Typewriter
                            text=", I imagine you're scaling capabilities fast."
                            start={startTyping}
                            delay={4000}
                            speed={20}
                          />
                        ...
                        <div
                          className={`transition-opacity duration-500 text-zinc-400 ${status === "done" ? "opacity-100" : "opacity-0"}`}
                        >
                          Best,
                          <br />
                    ...
                    <>
                      <div className="grid grid-cols-[60px_1fr] gap-6 mb-10 text-sm border-b border-white/[0.04] pb-3 items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="bg-[#0077b5]/10 text-[#0077b5] px-3 py-1 rounded-lg text-xs border border-[#0077b5]/20 shadow-[0_0_10px_rgba(0,119,181,0.1)] font-medium">
                            Sarah Chen
                          </span>
                        </div>
                        <span className="text-zinc-500 font-bold uppercase text-xs tracking-wider">
                      ...
                      <div
                        className={`relative pl-6 border-l-2 transition-all duration-500 ${startTyping ? "border-[#0077b5] shadow-[inset_14px_0_20px_-10px_rgba(0,119,181,0.2)]" : "border-transparent"}`}
                      >
                        ...
                        <div className="mb-6 flex flex-wrap gap-x-1 gap-y-2 items-center text-zinc-300">
                          ...
                          />
                          <Typewriter
                            text=" at TechFlow! With your recent "
                            start={startTyping}
                            delay={2200}
                            speed={20}
                          />
                          ...
                          />
                          <Typewriter
                            text=", I'd love to connect and share how we help AI leaders scale their outreach."
                            start={startTyping}
                            delay={3200}
                            speed={20}
                          />
                        ...
                        >
                          Best,
                          <br />
                          <span className="text-[#0077b5] font-bold">Alex</span>
                        </div>
                      </div>
                    </>
                  )}
                ...
                {(activeTab === "email" || activeTab === "linkedin") && (
                  <div className="h-20 bg-black/40 border-t border-white/[0.04] flex items-center justify-between px-8 shrink-0 backdrop-blur-sm">
                    <div className="flex items-center gap-3 text-zinc-500 hover:text-zinc-300 cursor-pointer transition-colors">
                      <MoreHorizontal className="w-5 h-5" />
                    </div>
                    <div className="flex items-center gap-4">
                      <button className="text-xs font-bold text-zinc-500 hover:text-white transition-colors px-3 py-1.5 uppercase tracking-wider">
                        Discard
                      </button>
                      <button className="text-xs font-bold text-zinc-300 hover:bg-white/[0.05] rounded-xl px-6 py-3 transition-colors border border-transparent hover:border-white/10">
                        Edit
                      </button>
                      <button
                        onClick={() => {

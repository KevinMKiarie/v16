...
const metrics = [
  {
    value: "50%",
    label: "Less Busywork",
    description: "Reduction in manual admin tasks for reps",
  },
  {
    value: "2.3x",
    label: "Pipeline Velocity",
    description: "Faster deal progression from meeting to close",
  },
  {
    value: "31%",
    label: "Higher Win Rates",
    description: "When reps use AI-guided deal execution",
  },
];
...
const pillars = [
  {
    ...
    description:
      "AI surfaces everything your rep needs before each call  company context, stakeholder map, previous touchpoints, and recommended talking points. No more scrambling 5 minutes before a demo.",
    features: [
      {
        icon: BrainCircuit,
        title: "AI Meeting Briefs",
        text: "Auto-generated dossiers with company news, tech stack, pain points, and competitive intel delivered before each meeting.",
      },
      {
        icon: CalendarCheck,
        title: "Smart Scheduling",
        text: "Custom booking links with automatic timezone detection, buffer time, and round-robin routing across your team.",
      },
      {
        icon: Target,
        title: "Stakeholder Mapping",
        text: "Visualize the buying committee  champions, decision-makers, and blockers  with relationship intelligence from your CRM.",
      },
    ],
  },
  {
    ...
    description:
      "After every call, Nexuscale handles the busywork: transcriptions, action items, follow-up emails, and CRM updates all happen automatically. Your reps get time back to actually sell.",
    features: [
      {
        icon: Mic,
        title: "Call Recording & Transcription",
        text: "Every call is recorded, transcribed, and summarized. Key moments are flagged so managers can coach without listening to full recordings.",
      },
      {
        icon: Mail,
        title: "AI Follow-Up Emails",
        text: "Automatically draft personalized follow-up emails based on what was discussed, with one-click send from the rep's inbox.",
      },
      {
        icon: RefreshCw,
        title: "Auto CRM Sync",
        text: "Meeting notes, next steps, deal stage changes, and contact updates are pushed to your CRM in real-time. Zero manual entry.",
      },
    ],
  },
  {
    ...
    description:
      "Every deal, every activity, every signal  unified in a single view. Managers get real-time forecasting, deal health scores, and coaching insights without chasing reps for updates.",
    features: [
      {
        icon: BarChart3,
        title: "Deal Health Dashboard",
        text: "AI analyzes engagement patterns, stakeholder activity, and timing signals to score the health of every deal in your pipeline.",
      },
      {
        icon: Bell,
        title: "Real-Time Deal Alerts",
        text: "Get notified when deals stall, champions go silent, or competitors enter the picture  before it's too late to act.",
      },
      {
        icon: Users,
        title: "Coaching & Performance",
        text: "Compare rep performance, identify winning patterns, and deliver targeted coaching with conversation intelligence insights.",
      },
    ],
  },
];
...
const testimonials = [
  {
    quote:
      "Our reps used to spend 3 hours a day on admin. With Nexuscale, CRM updates, follow-ups, and meeting prep are fully automated. They just sell now.",
    name: "Alex Thompson",
    role: "VP of Sales",
    company: "CloudReach",
  },
  {
    quote:
      "$2.3M in pipeline sourced through Nexuscale in Q1 alone. The AI meeting briefs mean our reps walk in more prepared than the competition every single time.",
    name: "Rachel Kwon",
    role: "CRO",
    company: "ScaleForce",
  },
  {
    quote:
      "Deal visibility went from guesswork to precision. I can see exactly which deals need attention without a single Slack message to my team.",
    name: "Michael Torres",
    role: "Sales Director",
    company: "PipelineIQ",
  },
...
const resources = [
  {
    ...
    description:
      "Pre-built templates for discovery calls, demos, and negotiation meetings.",
    tag: "Template",
  },
  {
    title: "Sales Execution Playbook",
    description:
      "A framework for running a repeatable, AI-assisted deal process.",
    tag: "Guide",
  },
  {
    title: "Pipeline Management Masterclass",
    description:
      "How top-performing teams manage pipeline with deal intelligence.",
    tag: "Webinar",
  },
  {
    title: "Conversation Intelligence Guide",
    description: "Using call recordings and AI analysis to improve win rates.",
    tag: "Guide",
  },
];
            ...
            <div>
              ...
              <ScrollReveal delay={200}>
                <p className="text-lg text-zinc-400 leading-relaxed mb-8">
                  Run more effective sales calls, automate the busywork, and
                  give managers full pipeline visibility all in one platform
                  that replaces your entire sales execution stack.
                </p>
              </ScrollReveal>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-24">
        <ScrollReveal>
          <div className="text-center mb-12">
            <p className="text-sm font-medium text-emerald-400 mb-3 tracking-wide uppercase">
              How It Works
            </p>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Prep. Progress. Manage.
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              AI handles the admin so your reps can focus on what they do best
              closing deals.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 md:p-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {currentPillar.features.map((f, i) => (
              <div
                key={i}
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 hover:border-emerald-500/20 transition-all"
              >

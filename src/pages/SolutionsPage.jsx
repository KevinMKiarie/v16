...
const metrics = [
  {
    ...
    description: "Global B2B database with real-time verification",
  },
  {
    value: "93%",
    label: "Email Accuracy",
    description: "Industry-leading deliverability rates",
  },
  {
    value: "10x",
  ...
  },
  {
    value: "60%",
    label: "Time Saved",
    description: "Reduction in manual prospecting effort",
  },
];
...
const outboundFeatures = [
  {
    ...
    description:
      "Automatically craft and send personalized multi-touch campaigns across email, LinkedIn, and calls.",
  },
  {
    icon: Send,
    title: "Smart Sending Engine",
    description:
      "Optimize send times, rotate mailboxes, and warm up domains to maximize deliverability.",
  },
  {
    icon: Target,
    title: "Intent-Based Targeting",
    description:
      "Identify accounts showing buying signals and prioritize outreach to high-intent prospects.",
  },
  {
    icon: MessageSquare,
    title: "Hyper-Personalization",
    description:
      "Generate unique messaging per prospect using AI that references their role, company, and activity.",
  },
];
...
const inboundFeatures = [
  {
    ...
    description:
      "Find and enrich inbound leads with firmographic, technographic, and intent data instantly.",
  },
  {
    icon: Filter,
    title: "Intelligent Lead Scoring",
    description:
      "Score and prioritize inbound leads based on fit, engagement, and buying readiness.",
  },
  {
    icon: Inbox,
    title: "Unified Inbox",
    description:
      "Manage all inbound conversations across channels in a single AI-assisted workspace.",
  },
  {
    icon: TrendingUp,
    title: "Conversion Optimization",
    description:
      "Automatically route, nurture, and follow up with inbound leads to maximize conversion rates.",
  },
];
...
const certifications = [
  ...
  },
  {
    ...
    description:
      "Meeting California Consumer Privacy Act requirements for data handling and transparency.",
    badge: "Compliant",
  },
  {
    icon: BadgeCheck,
    title: "DPA Ready",
    description:
      "Pre-signed Data Processing Agreements available for enterprise customers.",
    badge: "Available",
  },
  {
    icon: Award,
    ...
    description:
      "Adherence to transatlantic data privacy frameworks for secure data transfers.",
    badge: "Verified",
  },
];
...
const whyReasons = [
  {
    ...
    description:
      "Replace 5+ tools with a single platform that handles data, outreach, deliverability, and analytics.",
    icon: Sparkles,
  },
  {
  ...
  },
  {
    ...
    description:
      "Access continuously verified contact and company data so your outreach never hits dead ends.",
    icon: Globe,
  },
  {
    title: "Enterprise-Grade Security",
    description:
      "SOC 2, GDPR, and ISO 27001 certified. Your data and your prospects' data stays protected.",
    icon: Shield,
  },
  {
    title: "Scales With You",
    description:
      "From startup to enterprise, the platform grows with your team without performance bottlenecks.",
    icon: TrendingUp,
  },
  {
    title: "Measurable ROI",
    description:
      "Track every touchpoint from first contact to closed deal with built-in attribution analytics.",
    icon: BarChart3,
  },
];
    ...
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-400 pb-20 md:pb-32">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <ScrollReveal delay={200}>
            <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Nexuscale unifies your inbound and outbound motions into a single
              AI-powered engine so your team spends less time searching and more
              time closing.
            </p>
          </ScrollReveal>
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 md:p-12 overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl">
              <p className="text-sm font-medium text-indigo-400 mb-4 tracking-wide uppercase">
                The Nexuscale Advantage
              </p>
              <h2 className="text-2xl md:text-3xl font-bold text-white leading-snug mb-6">
                One platform to find, engage, and convert your ideal customers
                powered by AI that actually understands your market.
              </h2>
              <p className="text-zinc-400 leading-relaxed mb-6">
                Most sales teams stitch together 5-8 different tools for data,
                outreach, deliverability, and analytics. Nexuscale replaces the
                entire stack with a unified platform that shares intelligence
                across every stage of your pipeline. Our AI doesn't just
                automate it learns your ideal customer profile, adapts messaging
                in real-time, and surfaces the signals that matter most.
              </p>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-24">
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">
              Whether you're reaching out or pulling leads in, Nexuscale has you
              covered.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {(activeTab === "outbound" ? outboundFeatures : inboundFeatures).map(
            (f, i) => (
        ...
        <ScrollReveal delay={400}>
          <div className="text-center mt-10">
            ...
            >
              Explore {activeTab === "outbound" ? "Outbound" : "Inbound"}{" "}
              Features
      ...
      <section className="max-w-5xl mx-auto px-6 mb-24">
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">
              Your data security is non-negotiable. We hold the certifications
              to prove it.
            </p>
          </div>
        </ScrollReveal>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-24">
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              The Unfair Advantage Your Team Needs
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Stop stitching tools together. Start closing more deals with a
              platform built for modern revenue teams.
            </p>
          </div>
        </ScrollReveal>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-10 md:p-14 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 mb-8 max-w-md mx-auto">
                Join thousands of teams using Nexuscale to close more deals,
                faster.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a

...
const metrics = [
  {
    ...
    description: "Verified B2B contacts enriched with 65+ data points",
  },
  {
    value: "35%",
    label: "Higher Win Rates",
    description: "When teams sell with enriched, accurate data",
  },
  {
    value: "72%",
    label: "Faster Prospecting",
    description: "Reduction in time spent researching leads",
  },
];
...
const pillars = [
  {
    ...
    description:
      "Enrich any contact or company record with 65+ attributes including firmographic, technographic, and intent data. Our waterfall enrichment checks multiple sources to maximize fill rates.",
    features: [
      {
        icon: Layers,
        title: "Waterfall Enrichment",
        text: "We query multiple data sources in sequence so you get the highest possible fill rate for every field  email, phone, title, tech stack, and more.",
      },
      {
        icon: Globe,
        title: "210M+ Contact Database",
        text: "Access one of the largest verified B2B databases, continuously updated with real-time verification and change detection.",
      },
      {
        icon: BrainCircuit,
        title: "AI Research Agents",
        text: "For data that doesn't fit neatly into fields, our AI agents perform custom research  funding history, tech stack changes, org charts, and more.",
      },
    ],
  },
  {
    ...
    description:
      "Not all data is created equal. Our AI scoring and intent signals help you focus on the contacts most likely to convert  so your team stops wasting time on dead ends.",
    features: [
      {
        icon: Target,
        title: "AI Lead Scoring",
        text: "Score every record against your ideal customer profile using firmographic fit, engagement signals, and historical conversion patterns.",
      },
      {
        icon: Activity,
        title: "Buyer Intent Signals",
        text: "Detect real-time buying signals  job changes, funding events, technology adoptions, and content engagement across the web.",
      },
      {
        icon: Search,
        title: "Custom AI Research",
        text: "Ask questions about any prospect in natural language and get structured answers sourced from public data, news, and filings.",
      },
    ],
  },
  {
    ...
    description:
      "Bad data costs you more than you think  bounced emails, wrong titles, missed signals. Nexuscale continuously cleanses and updates your records so your CRM is always ready to sell.",
    features: [
      {
        icon: CheckCircle2,
        title: "Automated CRM Updates",
        text: "Detect stale records, job changes, and company changes automatically. Push corrections to your CRM without manual intervention.",
      },
      {
        icon: Upload,
        title: "CSV & Bulk Enrichment",
        text: "Upload any list  CSV, spreadsheet, or export  and enrich thousands of records in minutes with full data append.",
      },
      {
        icon: Plug,
        title: "API & Integrations",
        text: "Enrich records in real-time via our REST API, or use native integrations with Salesforce, HubSpot, and Pipedrive for continuous sync.",
      },
    ],
  },
];
...
const testimonials = [
  {
    quote:
      "We've 3x'd our annual revenue since switching to Nexuscale. The data quality is in a completely different league from what we had before.",
    name: "James Rivera",
    role: "Founder & CEO",
  ...
  {
    quote:
      "Data quality improved by 50% overnight compared to our previous provider. Our reps finally trust the CRM because the data is actually accurate.",
    name: "Lisa Nakamura",
  ...
  {
    quote:
      "We enrich 100k+ leads daily without breaking a sweat. The API is fast, reliable, and the fill rates are consistently above 85%.",
    name: "David Okafor",
    role: "VP Engineering",
    company: "DataForge",
  },
...
const resources = [
  {
    title: "CRM Data Enrichment Playbook",
    description:
      "Step-by-step guide to cleaning and enriching your CRM in under a week.",
    tag: "Guide",
  },
  {
    title: "Waterfall Enrichment Explained",
    description: "How multi-source enrichment achieves 90%+ fill rates.",
    tag: "Article",
  },
  {
    title: "Data Quality ROI Calculator",
    description: "Calculate how much bad data is costing your revenue team.",
    tag: "Tool",
  },
  {
    title: "Enterprise Data Strategy Webinar",
    description: "How scaling teams build a data-first revenue engine.",
    tag: "Webinar",
  },
];
            ...
            <div>
              ...
              <ScrollReveal delay={200}>
                <p className="text-lg text-zinc-400 leading-relaxed mb-8">
                  Stop chasing the wrong leads. Enrich every record with
                  verified contact data, firmographics, and buying signals
                  powered by 210M+ contacts and AI research.
                </p>
              </ScrollReveal>
              ...
              <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 overflow-hidden">
                ...
                <div className="relative space-y-3">
                  ...
                  {[
                    ...
                    {
                      field: "Tech Stack",
                      value: "AWS, React, Snowflake",
                      status: "enriched",
                    },
                    {
                      field: "Buying Intent",
                      value: "High  evaluating CRMs",
                      status: "detected",
                    },
                  ].map((r, i) => (
                    <div
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Enrich. Qualify. Cleanse.
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              A complete data engine that ensures every record in your CRM is
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 md:p-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {currentPillar.features.map((f, i) => (
              <div
                key={i}
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 hover:border-violet-500/20 transition-all"
              >
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-10 md:p-14 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 mb-8 max-w-md mx-auto">
                With data you can actually rely on. Start enriching your
                pipeline today.
              </p>

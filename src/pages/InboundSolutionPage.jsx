...
const metrics = [
  {
    ...
    description: "Increase in inbound lead-to-meeting rate",
  },
  {
    value: "3.2x",
    label: "Meeting Bookings",
    description: "More demos booked from inbound traffic",
  },
  {
    value: "58%",
    label: "Less Tool Spend",
    description: "Reduction in technology stack costs",
  },
];
...
const pillars = [
  {
    ...
    description:
      "Most of your website traffic leaves without converting. Nexuscale unmasks anonymous visitors, identifies decision-makers, and gives your team the intelligence to engage before leads go cold.",
    features: [
      {
        icon: Globe,
        title: "Website Visitor Tracking",
        text: "See which companies are browsing your site in real-time, even if they never fill out a form.",
      },
      {
        icon: Users,
        title: "Decision-Maker Discovery",
        text: "AI automatically identifies the right contacts at visiting accounts based on your ideal customer profile.",
      },
      {
        icon: BrainCircuit,
        title: "AI Research Prompts",
        text: "Generate instant context on any visitor  company size, tech stack, funding, and buying signals.",
      },
    ],
  },
  {
    ...
    description:
      "Every form field you add costs you conversions. Nexuscale enriches submissions in real-time with 65+ data points so you can keep forms short while capturing everything your sales team needs.",
    features: [
      {
        icon: Sparkles,
        title: "Form Enrichment",
        text: "Capture just an email  we auto-fill job title, company, industry, revenue, and 60+ more fields instantly.",
      },
      {
        icon: UserCheck,
        title: "Lead Qualification",
        text: "AI scores and qualifies every submission against your ICP in real-time, before it reaches your CRM.",
      },
      {
        icon: Filter,
        title: "Smart Routing",
        text: "Route high-intent leads directly to the right rep based on territory, segment, or account ownership.",
      },
    ],
  },
  {
    ...
    description:
      "Speed-to-lead determines whether you win or lose. Nexuscale automates routing, follow-up, and nurturing so no inbound lead ever waits for a human to take action.",
    features: [
      {
        icon: Route,
        title: "Intelligent Lead Routing",
        text: "Auto-assign leads to the right rep instantly based on custom rules  territory, company size, or deal stage.",
      },
      {
        icon: CalendarCheck,
        title: "Instant Meeting Booking",
        text: "Let qualified leads book directly on rep calendars, embedded in your forms or triggered by lead score.",
      },
      {
        icon: Bot,
        title: "AI Workflow Engine",
        text: "Build no-code automation flows that trigger sequences, update CRM fields, and alert reps in real-time.",
      },
    ],
  },
];
...
const testimonials = [
  {
    quote:
      "We went from losing 60% of our inbound leads to converting nearly half of them into qualified meetings. Nexuscale's visitor tracking changed everything.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "Our forms went from 8 fields to 2, and we're actually capturing more data than before. The enrichment is instant and incredibly accurate.",
    name: "Marcus Johnson",
    role: "Head of Growth",
    company: "DataBridge",
  },
  {
    quote:
      "Speed-to-lead dropped from 4 hours to under 2 minutes. Our reps are engaging leads while they're still on the website.",
    name: "Priya Patel",
    role: "Sales Director",
    company: "CloudSync",
  },
...
const resources = [
  {
    title: "Inbound Lead Sequence Templates",
    description:
      "Pre-built multi-touch sequences optimized for inbound follow-up.",
    tag: "Template",
  },
  {
    title: "Website Visitor Playbook",
    description:
      "How to identify, qualify, and engage anonymous website traffic.",
    tag: "Guide",
  },
  {
    title: "Form Optimization Guide",
    description: "Reduce form fields by 70% without losing data quality.",
    tag: "Guide",
  },
  {
    title: "Inbound + Outbound Integration",
    description:
      "Combine your inbound and outbound motions for maximum pipeline.",
    tag: "Webinar",
  },
];
            ...
            <div>
              ...
              <ScrollReveal delay={200}>
                <p className="text-lg text-zinc-400 leading-relaxed mb-8">
                  Never let a hot lead go cold again. Turn every inbound visit
                  into pipeline with visitor tracking, form enrichment, and
                  automatic routing.
                </p>
              </ScrollReveal>
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Identify. Capture. Automate.
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              A three-step engine that turns anonymous traffic into booked
              meetings.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 md:p-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {currentPillar.features.map((f, i) => (
              <div
                key={i}
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 hover:border-indigo-500/20 transition-all"
              >
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-10 md:p-14 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 mb-8 max-w-md mx-auto">
                Don't let them go cold. Start converting inbound traffic into
                qualified pipeline today.
              </p>

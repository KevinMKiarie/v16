...
const metrics = [
  {
    value: "5x",
    label: "More Replies",
    description: "Increase in positive response rates with AI personalization",
  },
  {
    value: "82%",
    label: "Inbox Placement",
    description: "Emails land in primary inbox, not spam or promotions",
  },
  {
    value: "3.8x",
    label: "Pipeline Generated",
    description: "More qualified pipeline from outbound motions",
  },
];
...
const pillars = [
  {
    ...
    description:
      "Stop guessing who to target. Nexuscale combines a 275M+ contact database with real-time intent signals and AI-powered list building to surface the accounts most likely to buy  right now.",
    features: [
      {
        icon: Globe,
        title: "275M+ Verified Contacts",
        text: "Search the largest B2B database with 65+ filters  title, industry, tech stack, funding, headcount, and more. Every email is verified in real-time.",
      },
      {
        icon: Target,
        title: "Intent-Based Lists",
        text: "Build lists based on buying signals  job changes, technology adoptions, funding rounds, and content engagement across the web.",
      },
      {
        icon: BrainCircuit,
        title: "AI List Builder",
        text: "Describe your ideal customer in plain language and let AI build a targeted prospect list in seconds, complete with enriched contact data.",
      },
    ],
  },
  {
    ...
    description:
      "One-size-fits-all outreach is dead. Nexuscale's AI writes unique messages for every prospect, sequences them across email, LinkedIn, and calls, and optimizes send times for maximum engagement.",
    features: [
      {
        icon: MessageSquare,
        title: "AI Hyper-Personalization",
        text: "Generate unique messaging per prospect referencing their role, company news, tech stack, and recent activity. No templates, no merge tags  real personalization.",
      },
      {
        icon: Layers,
        title: "Multi-Channel Sequencing",
        text: "Orchestrate automated sequences across email, LinkedIn (connection requests, messages, InMail), and phone  all from a single workflow builder.",
      },
      {
        icon: Clock,
        title: "Smart Send Optimization",
        text: "AI determines the optimal send time per prospect based on timezone, past engagement patterns, and inbox activity to maximize open rates.",
      },
    ],
  },
  {
    ...
    description:
      "The best messaging in the world is worthless if it never reaches the prospect. Our deliverability engine handles warmup, rotation, monitoring, and reputation management so every email lands where it should.",
    features: [
      {
        icon: RefreshCw,
        title: "Automated Mailbox Warmup",
        text: "Gradually build sender reputation with intelligent warmup that mimics real human email behavior across your sending domains.",
      },
      {
        icon: Settings,
        title: "Domain & Mailbox Rotation",
        text: "Automatically rotate across multiple sending domains and mailboxes to distribute volume and protect deliverability at scale.",
      },
      {
        icon: BarChart3,
        title: "Real-Time Health Monitoring",
        text: "Track bounce rates, spam complaints, and inbox placement in real-time. Get alerts before deliverability issues impact your campaigns.",
      },
    ],
  },
];
...
const testimonials = [
  {
    quote:
      "We replaced 4 different tools with Nexuscale's outbound stack. Our reps went from sending 50 generic emails a day to 200 AI-personalized touches across 3 channels.",
    name: "Jordan Hayes",
  ...
  {
    quote:
      "Deliverability was killing our outbound before Nexuscale. Now we're at 82% inbox placement and our reply rates have tripled. The warmup and rotation tools are a game-changer.",
    name: "Natasha Kim",
  ...
  {
    quote:
      "The AI personalization is genuinely impressive. Prospects actually reply saying 'this doesn't feel like a cold email.' That's never happened before with any tool we've used.",
    name: "Daniel Osei",
    role: "Founder & CEO",
    company: "PipeGen",
  },
...
const resources = [
  {
    title: "Cold Email Playbook 2025",
    description:
      "The complete framework for cold outreach that converts in the AI era.",
    tag: "Guide",
  },
  {
    title: "Multi-Channel Sequence Templates",
    description:
      "Pre-built sequences combining email, LinkedIn, and phone touchpoints.",
    tag: "Template",
  },
  {
    title: "Deliverability Masterclass",
    description:
      "How to achieve and maintain 80%+ inbox placement rates at scale.",
    tag: "Webinar",
  },
  {
    title: "AI Personalization Examples",
    description:
      "Real examples of AI-generated outreach that drove meetings and pipeline.",
    tag: "Article",
  },
];
            ...
            <div>
              ...
              <ScrollReveal delay={200}>
                <p className="text-lg text-zinc-400 leading-relaxed mb-8">
                  Find the right prospects, engage them with AI-personalized
                  multi-channel campaigns, and land in the inbox every time all
                  from one platform.
                </p>
              </ScrollReveal>
              ...
              <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 overflow-hidden">
                ...
                <div className="relative space-y-3">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className="py-3 px-4 rounded-lg bg-white/[0.02] border border-white/[0.04] space-y-2"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {s.channels.includes("linkedin") && (
                            <Linkedin className="w-3 h-3 text-blue-400" />
                          )}
                          {s.channels.includes("phone") && (
                      ...
                      <div className="w-full h-1.5 rounded-full bg-white/[0.06] overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(s.replied / s.contacts) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Prospect. Engage. Deliver.
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              A complete outbound engine from finding the right contacts to
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 md:p-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {currentPillar.features.map((f, i) => (
              <div
                key={i}
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 hover:border-blue-500/20 transition-all"
              >
          ...
          {faqs.map((faq, i) => (
            <ScrollReveal key={i} delay={i * 60}>
              <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden">
                ...
                >
                  <p className="px-6 text-sm text-zinc-400 leading-relaxed">
                    {faq.a}
                  </p>
                </div>
              </div>
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-10 md:p-14 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 mb-8 max-w-md mx-auto">
                AI-powered outbound that finds, engages, and converts your ideal
                buyers.
              </p>
